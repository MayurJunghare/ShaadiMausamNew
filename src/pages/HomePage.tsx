    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <main className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-maroon-500 mb-2 flex items-center justify-center gap-2 flex-wrap">
        ...
        <div className="space-y-6 mb-10">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
            ...
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-maroon-500 hover:bg-maroon-600 text-white px-6 py-3 rounded-lg font-semibold transition-colors mb-2"
            >
              <Send size={20} />
        ...
        <div className="text-center">
          <button
            ...
            className={`inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-semibold text-lg transition-all shadow-md min-h-[52px] ${
              startDate && location && !isAnalyzing
                ? 'bg-gradient-to-r from-gold-500 via-rose-500 to-maroon-600 hover:from-gold-600 hover:via-rose-600 hover:to-maroon-700 text-white shadow-lg'
                : 'bg-gray-300 hover:bg-gray-400 text-gray-800 cursor-not-allowed opacity-80'
            }`}
